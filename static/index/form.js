document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelectorAll(".input-form-title").forEach(title => {
        title.addEventListener("input", function(){
            ...
            document.title = `${this.value} - Easy Survey`
    ...
    document.querySelectorAll(".textarea-adjust").forEach(tx => {
        ...
        tx.style.height = (30 + tx.scrollHeight)+"px";
  ...
  document.querySelector("#add-question").addEventListener("click", () => {
    ...
    console.log("Form status:", formStatus.getHTML());
    if (formStatus.getHTML() == "Edit"){        
        document.getElementById("publish-form-btn").addEventListener("click", function (event) {
            ...
            .then(data => {
                alert("Form published successfully!"); // Alert success message
    ...
    } else if (formStatus.getHTML() == "Publish") {        
        document.getElementById("close-form-btn").addEventListener("click", function (event) {
            ...
            .then(response => response.text())
            .then(data => {
                alert("Form closed successfully!"); // Alert success message
                window.location.reload();
            })
            .catch(error => {
                alert(error);
    ...
    } else if (formStatus.getHTML() == "Close") {        
        document.getElementById("republish-form-btn").addEventListener("click", function (event) {
            event.preventDefault(); // Prevent default form submission
            const csrf = Cookies.get('csrftoken');
            const form = document.getElementById("republish-form");
            const url = form.action;
            ...
            .then(response => response.text())
            .then(data => {
                alert("Form republished successfully!"); // Alert success message
                window.location.reload();
            })
            .catch(error => {
                alert(error);
